...
class DeepResearchValidator(OrganicHistoryMixin):
    def __init__(self, neuron: AbstractNeuron):
        ...
        self.reward_weights = torch.tensor(
            [
                self.neuron.config.reward.deep_research_content_relevance_weight,
                self.neuron.config.reward.deep_research_data_relevance_weight,
                self.neuron.config.reward.deep_research_logical_coherence_relevance_weight,
                self.neuron.config.reward.deep_research_source_links_relevance_weight,
                self.neuron.config.reward.deep_research_system_message_relevance_weight,
        ...
        self.reward_functions = [
            (
                ...
                if self.neuron.config.reward.deep_research_content_relevance_weight > 0
            ...
            (
                ...
                if self.neuron.config.reward.deep_research_data_relevance_weight > 0
            ...
            (
                ...
                if self.neuron.config.reward.deep_research_logical_coherence_relevance_weight
                > 0
                else MockRewardModel(
            ...
            (
                ...
                if self.neuron.config.reward.deep_research_source_links_relevance_weight
                > 0
                else MockRewardModel(
            ...
            (
                ...
                if self.neuron.config.reward.deep_research_system_message_relevance_weight
                > 0
                else MockRewardModel(
