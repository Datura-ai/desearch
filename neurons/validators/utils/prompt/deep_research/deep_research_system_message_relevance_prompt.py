...
When evaluating, report data is provided in json structure, so you need to decode the json data and understand the report data first.
Follow these steps.

1. Input Information
-Report data: <Report>
 Report data is string representation of json object.
 Report data is an array of section data. Each section has field of title, description, links and subsections. title and description are represented in string and links are an array of string of link. And subsection is an array of sections data in json format.
